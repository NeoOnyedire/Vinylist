// Same-origin by default: on Vercel, the frontend and /api/* serverless
// functions live on the same domain, so no base URL or CORS setup is needed.
// VITE_API_URL is only for pointing at a different backend if you ever split them.
